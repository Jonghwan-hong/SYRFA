...
class MappingNetwork(torch.nn.Module):
    def __init__(self, depth=5):
        ...
        for i in range(depth):
            self.weight1.append(nn.Parameter(torch.ones((32, 9, 32, 32))))
            self.bias1.append(nn.Parameter(torch.zeros((32, 9, 32, 32))))

            self.weight2.append(nn.Parameter(torch.ones((64, 9, 16, 16))))
            self.bias2.append(nn.Parameter(torch.zeros((64, 9, 16, 16))))
